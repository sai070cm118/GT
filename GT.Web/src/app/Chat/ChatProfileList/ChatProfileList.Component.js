...
var ChatProfileListComponent = (function () {
    function ChatProfileListComponent() {
        this.viewUserChat = new core_1.EventEmitter();
    }
    ChatProfileListComponent.prototype.selectUser = function ($user) {
        this.viewUserChat.emit({ selectedUser: $user });
    };
...
], ChatProfileListComponent.prototype, "chatProfiles", void 0);
__decorate([
    core_1.Output(),
    __metadata("design:type", Object)
...
exports.ChatProfileListComponent = ChatProfileListComponent;
